...
const aboutData = {
  ...
  education: [
    { year: "2015 - 2020", unv: "Arizona State University", degree: "B.S. Software Engineering" },
  ...
  working: [
    ...
    { year: "2021 - Present", company: "UIUC - Smart MOOCs", deg: "Software Engineer" },
    { year: "2020 - 2021", company: "Planet.com", deg: "Software Engineer" },
    { year: "2018 - 2021", company: "Honeywell Connected Enterprise", deg: "Software Engineer" },
    { year: "2018 - 2020", company: "CodeDevils", deg: "Webmaster" },
    { year: "2017 - 2018", company: "Honeywell Aerospace", deg: "Systems Engineer" },
  ],
  // partnersLogos: [
  //   "img/partners/1.png",
  //   "img/partners/2.png",
